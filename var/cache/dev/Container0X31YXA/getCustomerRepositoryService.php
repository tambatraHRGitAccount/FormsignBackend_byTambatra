...
class getCustomerRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CustomerRepository.php';

        return $container->privates['App\\Repository\\CustomerRepository'] = new \App\Repository\CustomerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
