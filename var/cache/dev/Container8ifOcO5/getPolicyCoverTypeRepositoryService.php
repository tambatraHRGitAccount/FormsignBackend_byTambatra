 ...
 */
class getPolicyCoverTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PolicyCoverTypeRepository' shared autowired service.
     *
     * @return \App\Repository\PolicyCoverTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PolicyCoverTypeRepository.php';

        return $container->privates['App\\Repository\\PolicyCoverTypeRepository'] = new \App\Repository\PolicyCoverTypeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
