 ...
 */
class getPaymentChildrenRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaymentChildrenRepository' shared autowired service.
     *
     * @return \App\Repository\PaymentChildrenRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaymentChildrenRepository.php';

        return $container->privates['App\\Repository\\PaymentChildrenRepository'] = new \App\Repository\PaymentChildrenRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
