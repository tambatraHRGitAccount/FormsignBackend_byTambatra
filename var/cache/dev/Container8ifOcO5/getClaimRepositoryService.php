 ...
 */
class getClaimRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClaimRepository' shared autowired service.
     *
     * @return \App\Repository\ClaimRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClaimRepository.php';

        return $container->privates['App\\Repository\\ClaimRepository'] = new \App\Repository\ClaimRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
