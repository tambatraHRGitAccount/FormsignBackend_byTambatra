...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerGWga2qp\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerGWga2qp/UriSignerGhostB68a0a1.php';
require __DIR__.'/ContainerGWga2qp/EntityManagerGhost614a58f.php';
require __DIR__.'/ContainerGWga2qp/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_UploadHandlerService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_Storage_FileSystemService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_PropertyMappingFactoryService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_MetadataReaderService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_Listener_Upload_KycDocumentsService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_Listener_Remove_KycDocumentsService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_Listener_Clean_KycDocumentsService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_Form_Type_ImageService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_Form_Type_FileService.php';
require __DIR__.'/ContainerGWga2qp/getVichUploader_DownloadHandlerService.php';
require __DIR__.'/ContainerGWga2qp/getValidator_WhenService.php';
require __DIR__.'/ContainerGWga2qp/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerGWga2qp/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerGWga2qp/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerGWga2qp/getValidator_ExpressionService.php';
require __DIR__.'/ContainerGWga2qp/getValidator_EmailService.php';
require __DIR__.'/ContainerGWga2qp/getUriSignerService.php';
require __DIR__.'/ContainerGWga2qp/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerGWga2qp/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerGWga2qp/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerGWga2qp/getTwigService.php';
require __DIR__.'/ContainerGWga2qp/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerGWga2qp/getSession_FactoryService.php';
require __DIR__.'/ContainerGWga2qp/getServicesResetterService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerGWga2qp/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerGWga2qp/getSecrets_VaultService.php';
require __DIR__.'/ContainerGWga2qp/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerGWga2qp/getRouting_LoaderService.php';
require __DIR__.'/ContainerGWga2qp/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Routes_DefaultService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_RouteDescribers_RouteArgumentService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_RenderDocsService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_ModelDescribers_ObjectService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Generator_DefaultService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Describers_Route_DefaultService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Describers_OpenapiPhp_DefaultService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Describers_ConfigService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Describers_ApiPlatformService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Controller_SwaggerYamlService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Controller_SwaggerUiService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Controller_SwaggerJsonService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Controller_StoplightService.php';
require __DIR__.'/ContainerGWga2qp/getNelmioApiDoc_Controller_RedoclyService.php';
require __DIR__.'/ContainerGWga2qp/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerGWga2qp/getErrorControllerService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerGWga2qp/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerGWga2qp/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerGWga2qp/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerGWga2qp/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerGWga2qp/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerGWga2qp/getContainer_GetenvService.php';
require __DIR__.'/ContainerGWga2qp/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerGWga2qp/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerGWga2qp/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerGWga2qp/getCache_SystemClearerService.php';
require __DIR__.'/ContainerGWga2qp/getCache_SystemService.php';
require __DIR__.'/ContainerGWga2qp/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerGWga2qp/getCache_AppClearerService.php';
require __DIR__.'/ContainerGWga2qp/getCache_AppService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Validator_State_ErrorProviderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Symfony_MainControllerService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_SwaggerUi_ProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_SwaggerUi_ContextService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_StateProvider_ParameterValidatorService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_StateProvider_ContentNegotiationService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_StateProvider_BackedEnumService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_StateProcessor_WriteService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_State_ErrorProviderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Serializer_FilterParameterProviderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Openapi_SerializerContextBuilderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Openapi_ProviderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_JsonSchema_BackwardCompatibleSchemaFactoryService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_LinksHandlerService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerGWga2qp/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerGWga2qp/getTransliteratorService.php';
require __DIR__.'/ContainerGWga2qp/getUploaderExtensionRuntimeService.php';
require __DIR__.'/ContainerGWga2qp/getUniqidNamer_KycDocumentsService.php';
require __DIR__.'/ContainerGWga2qp/getUniqidNamerService.php';
require __DIR__.'/ContainerGWga2qp/getSubdirDirectoryNamerService.php';
require __DIR__.'/ContainerGWga2qp/getSmartUniqueNamerService.php';
require __DIR__.'/ContainerGWga2qp/getPropertyNamerService.php';
require __DIR__.'/ContainerGWga2qp/getPropertyDirectoryNamerService.php';
require __DIR__.'/ContainerGWga2qp/getOrignameNamerService.php';
require __DIR__.'/ContainerGWga2qp/getHashNamerService.php';
require __DIR__.'/ContainerGWga2qp/getCurrentDateTimeDirectoryNamerService.php';
require __DIR__.'/ContainerGWga2qp/getConfigurableDirectoryNamerService.php';
require __DIR__.'/ContainerGWga2qp/getBase64NamerService.php';
require __DIR__.'/ContainerGWga2qp/getTemplateControllerService.php';
require __DIR__.'/ContainerGWga2qp/getRedirectControllerService.php';
require __DIR__.'/ContainerGWga2qp/getRenewalsProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getReceiptsProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getPoliciesSearchProviderService.php';
require __DIR__.'/ContainerGWga2qp/getPoliciesProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getPaymentsProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getFamilySearchProviderService.php';
require __DIR__.'/ContainerGWga2qp/getFamilyProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getDocsProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getCustomerSearchProviderService.php';
require __DIR__.'/ContainerGWga2qp/getClientProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getClaimsProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getAuthorisationSearchProviderService.php';
require __DIR__.'/ContainerGWga2qp/getAuthorisationProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getAppointmentProcessorService.php';
require __DIR__.'/ContainerGWga2qp/getRenewalsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getReceiptsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getProfileRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getPoliciesRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getPaymentsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getPasteErrorsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getNameAutocorrectSaveFailuresRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getMissingDocumentsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getInstructionsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getFamilyRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getDocsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getDebtorsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getClientsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getClaimsRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getAccMonthyearRepositoryService.php';
require __DIR__.'/ContainerGWga2qp/getDocControllerService.php';
require __DIR__.'/ContainerGWga2qp/get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerGWga2qp/get_ServiceLocator_ZHyJIs5_KernelloadRoutesService.php';
require __DIR__.'/ContainerGWga2qp/get_ServiceLocator_ZHyJIs5Service.php';
require __DIR__.'/ContainerGWga2qp/get_ServiceLocator_SBIwG_Service.php';
require __DIR__.'/ContainerGWga2qp/get_ServiceLocator_H0sWxY9Service.php';
require __DIR__.'/ContainerGWga2qp/get_ServiceLocator_AVKDDNUService.php';
require __DIR__.'/ContainerGWga2qp/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_UidService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerGWga2qp/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\DocController';
$classes[] = 'App\Repository\AccMonthyearRepository';
$classes[] = 'App\Repository\ClaimsRepository';
$classes[] = 'App\Repository\ClientsRepository';
$classes[] = 'App\Repository\DebtorsRepository';
$classes[] = 'App\Repository\DocsRepository';
$classes[] = 'App\Repository\FamilyRepository';
$classes[] = 'App\Repository\InstructionsRepository';
$classes[] = 'App\Repository\MissingDocumentsRepository';
$classes[] = 'App\Repository\NameAutocorrectSaveFailuresRepository';
$classes[] = 'App\Repository\PasteErrorsRepository';
$classes[] = 'App\Repository\PaymentsRepository';
$classes[] = 'App\Repository\PoliciesRepository';
$classes[] = 'App\Repository\ProfileRepository';
$classes[] = 'App\Repository\ReceiptsRepository';
$classes[] = 'App\Repository\RenewalsRepository';
$classes[] = 'App\State\AppointmentProcessor';
$classes[] = 'App\State\AuthorisationProcessor';
$classes[] = 'App\State\AuthorisationSearchProvider';
$classes[] = 'App\State\ClaimsProcessor';
$classes[] = 'App\State\ClientProcessor';
$classes[] = 'App\Service\ClientService';
$classes[] = 'App\State\CustomerSearchProvider';
$classes[] = 'App\State\DocsProcessor';
$classes[] = 'App\State\FamilyProcessor';
$classes[] = 'App\State\FamilySearchProvider';
$classes[] = 'App\State\PaymentsProcessor';
$classes[] = 'App\State\PoliciesProcessor';
$classes[] = 'App\State\PoliciesSearchProvider';
$classes[] = 'App\State\ReceiptsProcessor';
$classes[] = 'App\State\RenewalsProcessor';
