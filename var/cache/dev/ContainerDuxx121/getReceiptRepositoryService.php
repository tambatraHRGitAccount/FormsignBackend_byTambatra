 ...
 */
class getReceiptRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReceiptRepository' shared autowired service.
     *
     * @return \App\Repository\ReceiptRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReceiptRepository.php';

        return $container->privates['App\\Repository\\ReceiptRepository'] = new \App\Repository\ReceiptRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
