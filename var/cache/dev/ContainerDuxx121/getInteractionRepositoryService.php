 ...
 */
class getInteractionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InteractionRepository' shared autowired service.
     *
     * @return \App\Repository\InteractionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InteractionRepository.php';

        return $container->privates['App\\Repository\\InteractionRepository'] = new \App\Repository\InteractionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
